...
for i in range(2):
    for j in range(3):
        ax[i, j].text(0.5, 0.5, str(i, j), frontsize=16, ha='center')
...
births = pd.read_csv('C:\Users\16082311\OneDrive\Документи\data\births-1669.csv')
...
fig, ax = plt.subplots(4, 4, share=True, sharey=True)
